...
function ConsentBanner({ onAccept, onDecline }) {
	return (
		<div
			style={styles.banner}
			className="flex justify-between items-end p-5 border-t border-ternary-light dark:border-ternary-dark"
		>
			<p>
				We use cookies to analyze website traffic. Do you consent to our
