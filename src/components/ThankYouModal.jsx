			...
			<main className="flex flex-col items-center justify-center h-full w-full">
				<div className="modal-wrapper flex items-center z-30">
					<div className="modal max-w-4xl mx-5 xl:max-w-4xl lg:max-w-4xl md:max-w-4xl h-1/2 bg-secondary-light dark:bg-primary-dark shadow-lg flex-row rounded-lg relative">
						...
						<div className="modal-footer mt-2 sm:mt-0 py-5 px-8 border0-t text-right flex justify-between gap-10 p-5 border-b border-ternary-light dark:border-ternary-dark">
							<span
								onClick={onClose}
								type="button"
