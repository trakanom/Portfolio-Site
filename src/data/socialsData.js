...
const SocialSharing = [
	{
		...
		icon: <FiFacebook />,
		url: (projectId) =>
			`https://www.facebook.com/sharer/sharer.php?u=${baseURL}/projects/${projectId}`,
	},
	{
		id: 2,
		name: "Twitter",
		...
		url: (projectId) =>
			`https://twitter.com/share?text=Wow, I just saw this awesome project by Mika Wisener! It's really cool; check it out! ${baseURL}/projects/${projectId}`,
	},
	{
		id: 3,
		name: "LinkedIn",
		icon: <FiLinkedin />,
		url: (projectId) =>
			`https://www.linkedin.com/shareArticle?mini=true&url=${baseURL}/projects/${projectId}`,
